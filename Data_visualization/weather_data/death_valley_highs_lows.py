...
path=Path("C:/Users/g3472/Desktop/py_projects_demo/Data_visualization/weather_data/death_valley_2021_simple.csv")
#给Path传入文件路径，得到一个实例
...
#设置图形的格式
ax.set_title("Daily High And Low Temperature,2021\nDeath Valley CA",fontsize=20)
